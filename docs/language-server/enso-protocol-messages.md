# Enso Protocol Message Specification
This document contains the specification of the Enso protocol messages. For
information on the design and architecture of the protocol, as well as its
transport formats, please look [here](./enso-protocol-architecture.md).
