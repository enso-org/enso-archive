...
public class CallArgumentInfo {
   ...
   * will contain a sentinel value of type {@link UnappliedArgumentSentinel} in that position. This
   * ensures that execution knows not to use a possible default value for this position.
   *
