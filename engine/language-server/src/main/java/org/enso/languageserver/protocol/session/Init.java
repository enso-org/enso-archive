...
public final class Init extends Table {
  ...
  public static void finishInitBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset); }
  public static void finishSizePrefixedInitBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset); }
