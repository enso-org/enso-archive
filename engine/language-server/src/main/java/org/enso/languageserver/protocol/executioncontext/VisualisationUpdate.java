...
public final class VisualisationUpdate extends Table {
  ...
  public static void finishVisualisationUpdateBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset); }
  public static void finishSizePrefixedVisualisationUpdateBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset); }
