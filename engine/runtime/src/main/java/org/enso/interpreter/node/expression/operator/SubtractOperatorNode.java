 ...
 *
 * PLEASE NOTE: This class is incredibly unsafe and should not be used. It
 * exists in the codebase as it will be refactored to be safe alongside the
 * standard library epic. It is never generated by the code generator at the
 * current time.
 */
@NodeInfo(shortName = "-")
