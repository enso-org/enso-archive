...
object Protocol {
  ...
  object DerivationConfig {
    implicit val configuration: Configuration =
      Configuration.default.withDiscriminator("method")
  }
  ...
  object Response {
    ...
    def error(id: Option[Id] = None, error: Error): Response =
...
//      implicit val paramArrayDecoder: Decoder[Array] = deriveUnwrappedDecoder
  ...
  object ServerCapabilitiesExperimental {
    implicit val serverCapabilitiesExperimentalEncoder
      : Encoder[ServerCapabilitiesExperimental] = deriveUnwrappedEncoder
    implicit val serverCapabilitiesExperimentalDecoder
      : Decoder[ServerCapabilitiesExperimental] = deriveUnwrappedDecoder
  }
  ...
  object ServerCapabilitiesWorkspace {
    implicit val serverCapabilitiesWorkspaceEncoder
      : Encoder[ServerCapabilitiesWorkspace] = deriveEncoder
    implicit val serverCapabilitiesWorkspaceDecoder
      : Decoder[ServerCapabilitiesWorkspace] = deriveDecoder
  }
  ...
  object ClientCapabilitiesExperimental {
    implicit val clientCapabilitiesExperimentalEncoder
      : Encoder[ClientCapabilitiesExperimental] = deriveUnwrappedEncoder
    implicit val clientCapabilitiesExperimentalDecoder
      : Decoder[ClientCapabilitiesExperimental] = deriveUnwrappedDecoder
  }
  ...
  object ClientCapabilitiesWorkspace {
    implicit val clientCapabilitiesWorkspaceEncoder
      : Encoder[ClientCapabilitiesWorkspace] = deriveEncoder
    implicit val clientCapabilitiesWorkspaceDecoder
      : Decoder[ClientCapabilitiesWorkspace] = deriveDecoder
  }
  ...
  object TextDocumentClientCapabilities {
    implicit val textDocumentClientCapabilitiesEncoder
      : Encoder[TextDocumentClientCapabilities] = deriveEncoder
    implicit val textDocumentClientCapabilitiesDecoder
      : Decoder[TextDocumentClientCapabilities] = deriveDecoder
  }
    ...
    try {
      ...
      decode[RequestOrNotification](input) match {
        ...
        case Right(requestOrNotification: RequestOrNotification) =>
          ...
          } yield response.asJson.printWith(
