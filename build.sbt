...
lazy val interpreter = (project in file("Interpreter"))
  .settings(
    ...
    libraryDependencies ++= jmh ++ Seq(
      ...
      "org.graalvm.sdk"        % "polyglot-tck"              % "19.2.0.1",
      "org.graalvm.truffle"    % "truffle-api"               % "19.2.0.1",
      "org.graalvm.truffle"    % "truffle-dsl-processor"     % "19.2.0.1",
      "org.graalvm.truffle"    % "truffle-tck"               % "19.2.0.1",
      "org.graalvm.truffle"    % "truffle-tck-common"        % "19.2.0.1",
