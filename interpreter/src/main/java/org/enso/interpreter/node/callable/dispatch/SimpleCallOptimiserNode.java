...
/**
 * Optimistic version of {@link CallOptimiserNode} for the non tail call recursive case. Tries to just
 * call the function. If that turns out to be a tail call, it replaces itself with a {@link
 * LoopingCallOptimiserNode}. Thanks to this design, the (much more common) case of calling a function in
...
public class SimpleCallOptimiserNode extends CallOptimiserNode {
  ...
  public Object executeDispatch(Object receiver, Object[] arguments) {
    try {
      return executeCallNode.executeCall(receiver, arguments);
